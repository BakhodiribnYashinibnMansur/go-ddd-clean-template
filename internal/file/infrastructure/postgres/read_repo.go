...
func (r *FileReadRepo) FindByID(ctx context.Context, id uuid.UUID) (*domain.FileView, error) {
...
func (r *FileReadRepo) List(ctx context.Context, filter domain.FileFilter) ([]*domain.FileView, int64, error) {
	conds := squirrel.And{}
