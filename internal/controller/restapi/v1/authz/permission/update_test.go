...
func TestUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			body:    `{"name":"updated_perm"}`,
			mockSetup: func(m *MockPermUC) {
				m.On("Update", mock.Anything, mock.AnythingOfType("*domain.Permission")).Return(nil)
			},
		...
		},
		{
			...
			body:    `{"name":"updated_perm"}`,
			mockSetup: func(m *MockPermUC) {
				m.On("Update", mock.Anything, mock.AnythingOfType("*domain.Permission")).
