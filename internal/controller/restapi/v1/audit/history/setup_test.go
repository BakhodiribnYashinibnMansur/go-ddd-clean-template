...
// ---------------------------------------------------------------------------
// MockEndpointHistoryUseCase implements ucendpointhistory.UseCaseI
// ---------------------------------------------------------------------------

type MockEndpointHistoryUseCase struct {
	mock.Mock
}
...
type MockMetricUseCase struct{ mock.Mock }
...
// ---------------------------------------------------------------------------
// Helper: build a *usecase.UseCase with mocked Audit.History sub-service
// ---------------------------------------------------------------------------

func buildUseCase(historyMock *MockEndpointHistoryUseCase) *usecase.UseCase {
	return &usecase.UseCase{
		Audit: &MockAuditUseCase{
			logUC:         new(MockAuditLogUseCase),
			historyUC:     historyMock,
			metricUC:      new(MockMetricUseCase),
