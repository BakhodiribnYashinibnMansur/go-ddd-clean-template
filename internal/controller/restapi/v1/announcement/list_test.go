...
func TestList(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:  "success",
			query: "?limit=10&offset=0&search=test&type=info",
			mockSetup: func(m *MockUseCase) {
				m.On("List", mock.Anything, mock.AnythingOfType("domain.AnnouncementFilter")).
					Return([]domain.Announcement{{Title: "Test"}}, int64(1), nil)
			},
