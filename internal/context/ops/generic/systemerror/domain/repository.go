...
type SystemErrorRepository interface {
	...
	FindByID(ctx context.Context, id SystemErrorID) (*SystemError, error)
...
type SystemErrorReadRepository interface {
	FindByID(ctx context.Context, id SystemErrorID) (*SystemErrorView, error)
