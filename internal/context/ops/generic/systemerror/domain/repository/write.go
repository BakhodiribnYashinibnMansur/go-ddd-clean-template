...
type SystemErrorRepository interface {
	Save(ctx context.Context, q shareddomain.Querier, entity *entity.SystemError) error
	FindByID(ctx context.Context, id entity.SystemErrorID) (*entity.SystemError, error)
	Update(ctx context.Context, q shareddomain.Querier, entity *entity.SystemError) error
