...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateRateLimit == nil {
		t.Error("CreateRateLimit handler not wired")
	}
	if bc.UpdateRateLimit == nil {
		t.Error("UpdateRateLimit handler not wired")
	}
	if bc.DeleteRateLimit == nil {
		t.Error("DeleteRateLimit handler not wired")
	}
	if bc.GetRateLimit == nil {
		t.Error("GetRateLimit handler not wired")
	}
	if bc.ListRateLimits == nil {
		t.Error("ListRateLimits handler not wired")
	}
}
