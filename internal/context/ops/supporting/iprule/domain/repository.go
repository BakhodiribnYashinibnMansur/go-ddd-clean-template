...
type IPRuleRepository interface {
	...
	FindByID(ctx context.Context, id IPRuleID) (*IPRule, error)
	Update(ctx context.Context, entity *IPRule) error
	Delete(ctx context.Context, id IPRuleID) error
...
type IPRuleReadRepository interface {
	FindByID(ctx context.Context, id IPRuleID) (*IPRuleView, error)
