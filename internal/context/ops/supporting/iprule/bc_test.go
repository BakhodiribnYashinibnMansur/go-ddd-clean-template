...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateIPRule == nil {
		t.Error("CreateIPRule handler not wired")
	}
	if bc.UpdateIPRule == nil {
		t.Error("UpdateIPRule handler not wired")
	}
	if bc.DeleteIPRule == nil {
		t.Error("DeleteIPRule handler not wired")
	}
	if bc.GetIPRule == nil {
		t.Error("GetIPRule handler not wired")
	}
	if bc.ListIPRules == nil {
		t.Error("ListIPRules handler not wired")
	}
}
