...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateTranslation == nil {
		t.Error("CreateTranslation handler not wired")
	}
	if bc.UpdateTranslation == nil {
		t.Error("UpdateTranslation handler not wired")
	}
	if bc.DeleteTranslation == nil {
		t.Error("DeleteTranslation handler not wired")
	}
	if bc.GetTranslation == nil {
		t.Error("GetTranslation handler not wired")
	}
	if bc.ListTranslations == nil {
		t.Error("ListTranslations handler not wired")
	}
}
