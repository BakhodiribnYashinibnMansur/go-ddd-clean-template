...
type TranslationRepository interface {
	Save(ctx context.Context, e *entity.Translation) error
	FindByID(ctx context.Context, id entity.TranslationID) (*entity.Translation, error)
	Update(ctx context.Context, e *entity.Translation) error
	Delete(ctx context.Context, id entity.TranslationID) error
