...
func TestNewFile(t *testing.T) {
	...
	uploaderID := uuid.New()
	f := entity.NewFile("stored_abc.png", "photo.png", "image/png", 1024, "/uploads/stored_abc.png", "https://cdn.example.com/stored_abc.png", &uploaderID)
...
func TestNewFile_NoUploader(t *testing.T) {
	...
	f := entity.NewFile("doc.pdf", "document.pdf", "application/pdf", 2048, "/uploads/doc.pdf", "https://cdn.example.com/doc.pdf", nil)
...
func TestReconstructFile(t *testing.T) {
	...
	f := entity.ReconstructFile(id, createdAt, "stored.jpg", "original.jpg", "image/jpeg", 512, "/uploads/stored.jpg", "https://cdn.example.com/stored.jpg", &uploaderID)
