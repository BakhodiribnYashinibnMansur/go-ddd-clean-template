...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateAnnouncement == nil {
		t.Error("CreateAnnouncement handler not wired")
	}
	if bc.UpdateAnnouncement == nil {
		t.Error("UpdateAnnouncement handler not wired")
	}
	if bc.DeleteAnnouncement == nil {
		t.Error("DeleteAnnouncement handler not wired")
	}
	if bc.GetAnnouncement == nil {
		t.Error("GetAnnouncement handler not wired")
	}
	if bc.ListAnnouncements == nil {
		t.Error("ListAnnouncements handler not wired")
	}
}
