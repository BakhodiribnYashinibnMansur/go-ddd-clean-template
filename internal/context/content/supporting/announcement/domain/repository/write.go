...
type AnnouncementRepository interface {
	Save(ctx context.Context, q shareddomain.Querier, e *entity.Announcement) error
	FindByID(ctx context.Context, id entity.AnnouncementID) (*entity.Announcement, error)
	Update(ctx context.Context, q shareddomain.Querier, e *entity.Announcement) error
	Delete(ctx context.Context, q shareddomain.Querier, id entity.AnnouncementID) error
