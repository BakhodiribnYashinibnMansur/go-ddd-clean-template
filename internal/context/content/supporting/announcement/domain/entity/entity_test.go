...
func TestNewAnnouncement(t *testing.T) {
	...
	a, _ := entity.NewAnnouncement(title, content, 1, nil, nil)
...
func TestAnnouncement_Publish(t *testing.T) {
	...
	a, _ := entity.NewAnnouncement(title, content, 0, nil, nil)
...
func TestReconstructAnnouncement(t *testing.T) {
	...
	a := entity.ReconstructAnnouncement(id.UUID(), now, now, title, content, true, &now, 5, nil, nil)
