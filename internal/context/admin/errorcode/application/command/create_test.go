...
func (m *mockErrorCodeRepo) FindByID(ctx context.Context, id uuid.UUID) (*domain.ErrorCode, error) {
	if m.findFn != nil {
...
func (m *mockErrorCodeRepo) Delete(_ context.Context, id uuid.UUID) error {
	m.deleted = id
	return nil
}
