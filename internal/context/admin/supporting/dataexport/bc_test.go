...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateDataExport == nil {
		t.Error("CreateDataExport handler not wired")
	}
	if bc.UpdateDataExport == nil {
		t.Error("UpdateDataExport handler not wired")
	}
	if bc.DeleteDataExport == nil {
		t.Error("DeleteDataExport handler not wired")
	}
	if bc.GetDataExport == nil {
		t.Error("GetDataExport handler not wired")
	}
	if bc.ListDataExports == nil {
		t.Error("ListDataExports handler not wired")
	}
}
