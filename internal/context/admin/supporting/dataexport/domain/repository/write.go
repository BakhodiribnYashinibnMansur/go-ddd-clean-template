...
type DataExportRepository interface {
	Save(ctx context.Context, entity *entity.DataExport) error
	Update(ctx context.Context, entity *entity.DataExport) error
	FindByID(ctx context.Context, id entity.DataExportID) (*entity.DataExport, error)
	Delete(ctx context.Context, id entity.DataExportID) error
}
