...
func TestNewSiteSetting(t *testing.T) {
	...
	s := entity.NewSiteSetting("site_name", "My Site", "string", "The name of the site")
...
func TestSiteSetting_Update(t *testing.T) {
	...
	s := entity.NewSiteSetting("site_name", "My Site", "string", "desc")
...
func TestReconstructSiteSetting(t *testing.T) {
	...
	s := entity.ReconstructSiteSetting(id.UUID(), now, now, "key", "val", "string", "desc")
