...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateSiteSetting == nil {
		t.Error("CreateSiteSetting handler not wired")
	}
	if bc.UpdateSiteSetting == nil {
		t.Error("UpdateSiteSetting handler not wired")
	}
	if bc.DeleteSiteSetting == nil {
		t.Error("DeleteSiteSetting handler not wired")
	}
	if bc.GetSiteSetting == nil {
		t.Error("GetSiteSetting handler not wired")
	}
	if bc.ListSiteSettings == nil {
		t.Error("ListSiteSettings handler not wired")
	}
}
