...
func TestNewBoundedContext(t *testing.T) {
	...
	if bc.CreateErrorCode == nil {
		t.Error("CreateErrorCode handler not wired")
	}
	if bc.UpdateErrorCode == nil {
		t.Error("UpdateErrorCode handler not wired")
	}
	if bc.DeleteErrorCode == nil {
		t.Error("DeleteErrorCode handler not wired")
	}
	if bc.GetErrorCode == nil {
		t.Error("GetErrorCode handler not wired")
	}
	if bc.ListErrorCodes == nil {
		t.Error("ListErrorCodes handler not wired")
	}
}
