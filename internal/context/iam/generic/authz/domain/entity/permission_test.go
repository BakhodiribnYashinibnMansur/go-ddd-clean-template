...
func TestNewPermission(t *testing.T) {
	...
	perm := entity.NewPermission("users.read", nil)
...
func TestNewPermission_WithParentID(t *testing.T) {
	...
	parentID := uuid.New()
	perm := entity.NewPermission("users.read.detail", &parentID)
...
func TestReconstructPermission(t *testing.T) {
	...
	perm := entity.ReconstructPermission(
		id, now, now, nil,
...
func TestPermission_Rename(t *testing.T) {
	...
	perm := entity.NewPermission("old_name", nil)
...
func TestPermission_SetDescription(t *testing.T) {
	...
	perm := entity.NewPermission("test", nil)
...
func TestPermission_AddScope(t *testing.T) {
	...
	perm.AddScope(entity.Scope{Path: "/api/a", Method: "GET"})
	perm.AddScope(entity.Scope{Path: "/api/b", Method: "POST"})
