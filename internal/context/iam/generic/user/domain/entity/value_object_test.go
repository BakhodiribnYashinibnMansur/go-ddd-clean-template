...
func TestNewPhone_Valid(t *testing.T) {
	...
	p, err := entity.NewPhone("+998901234567")
...
func TestNewPhone_MissingPlus(t *testing.T) {
	...
	_, err := entity.NewPhone("998901234567")
	if err == nil {
...
func TestNewEmail_Valid(t *testing.T) {
	...
	e, err := entity.NewEmail("user@example.com")
	require.NoError(t, err)
...
func TestNewEmail_MissingAt(t *testing.T) {
	...
	_, err := entity.NewEmail("userexample.com")
	if err == nil {
		t.Fatal("expected error for missing @")
	}
}
...
func TestNewPasswordFromRaw_Valid(t *testing.T) {
	...
	pw, err := entity.NewPasswordFromRaw("SecureP@ss1")
	require.NoError(t, err)
	if pw.Hash() == "" {
...
func TestNewPasswordFromRaw_TooShort(t *testing.T) {
	...
	_, err := entity.NewPasswordFromRaw("short")
	if err == nil {
...
func TestPassword_CompareWrong(t *testing.T) {
	...
	pw, _ := entity.NewPasswordFromRaw("CorrectPassword1")
...
func TestNewPasswordFromHash(t *testing.T) {
	...
	pw, _ := entity.NewPasswordFromRaw("TestPassword1")
	reconstructed := entity.NewPasswordFromHash(pw.Hash())
...
func TestNewPhone_Unicode(t *testing.T) {
	...
	_, err := entity.NewPhone("+٩٩٨٩٠١٢٣٤٥٦٧")
...
func TestNewPhone_TableDriven(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			_, err := entity.NewPhone(tt.input)
...
func TestNewEmail_TableDriven(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			_, err := entity.NewEmail(tt.input)
			if (err != nil) != tt.wantErr {
...
func TestNewPasswordFromRaw_ExactlyMinLength(t *testing.T) {
	...
	pw, err := entity.NewPasswordFromRaw("12345678")
	require.NoError(t, err)
...
func TestNewPasswordFromRaw_SevenChars(t *testing.T) {
	...
	_, err := entity.NewPasswordFromRaw("1234567")
	if err == nil {
...
func TestNewPasswordFromRaw_UnicodePassword(t *testing.T) {
	...
	pw, err := entity.NewPasswordFromRaw("パスワード12345678")
	require.NoError(t, err)
...
func TestPassword_DifferentHashesForSameInput(t *testing.T) {
	...
	pw1, _ := entity.NewPasswordFromRaw("SamePassword1")
	pw2, _ := entity.NewPasswordFromRaw("SamePassword1")
