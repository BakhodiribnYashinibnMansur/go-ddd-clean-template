...
func (l *logger) Debugc(ctx context.Context, msg string, keysAndValues ...interface{}) {
	ctx = safeContext(ctx)
	fields := extractFields(ctx)
	l.ctxZap.Debugw(msg, mergeFields(fields, keysAndValues...)...)
}

func (l *logger) Infoc(ctx context.Context, msg string, keysAndValues ...interface{}) {
	ctx = safeContext(ctx)
	fields := extractFields(ctx)
	l.ctxZap.Infow(msg, mergeFields(fields, keysAndValues...)...)
}

func (l *logger) Warnc(ctx context.Context, msg string, keysAndValues ...interface{}) {
	ctx = safeContext(ctx)
	fields := extractFields(ctx)
	l.ctxZap.Warnw(msg, mergeFields(fields, keysAndValues...)...)
}

func (l *logger) Errorc(ctx context.Context, msg string, keysAndValues ...interface{}) {
	ctx = safeContext(ctx)
	fields := extractFields(ctx)
	l.ctxZap.Errorw(msg, mergeFields(fields, keysAndValues...)...)
}

func (l *logger) Fatalc(ctx context.Context, msg string, keysAndValues ...interface{}) {
	ctx = safeContext(ctx)
	fields := extractFields(ctx)
